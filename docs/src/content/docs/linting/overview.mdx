...
Project-wide rules can be slow on large projects. If you experience latency in the editor, disable them in config and enable them in CI via `graphql check --rule unusedFields=error`.
