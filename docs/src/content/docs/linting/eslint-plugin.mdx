...
- **Three rules carry pre-`no-` names:** `unused-fields`, `unused-fragments`,
  and `unused-variables` — these will be renamed to `no-unused-*` for true
  drop-in parity before the first stable release.
