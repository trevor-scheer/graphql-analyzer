...
This is a project-wide rule — it checks all documents together. It may be slower on large projects. Consider enabling it in CI only via [tool-specific overrides](/graphql-analyzer/configuration/tool-overrides/).
