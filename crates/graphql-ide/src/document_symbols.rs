//! Document Symbols feature implementation.
//!
//! This module provides IDE document symbol functionality including:
//! - Hierarchical outline for files (types, operations, fragments)
//! - Workspace symbol search across all files
//! - Field children for type definitions
...
pub fn document_symbols(
    ...
    for (name, kind, ranges) in definitions {
        ...
        let symbol = match kind {
            "object" => {
                let children =
                    get_field_children(&structure, &name, &parse.tree, &line_index, line_offset);
            ...
            "mutation" => DocumentSymbol::new(name, SymbolKind::Mutation, range, selection_range),
            "subscription" => {
